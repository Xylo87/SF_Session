...
-- Listage des données de la table sf_session.programme : ~9 rows (environ)
...
INSERT INTO `session` (`id`, `formation_id`, `formateur_id`, `nom`, `nb_places`, `date_debut`, `date_fin`) VALUES
	...
	(10, 2, 2, 'PIT-2024-01', 8, '2024-11-01 00:00:00', '2025-04-01 00:00:00');
...
-- Listage des données de la table sf_session.session_stagiaire : ~17 rows (environ)
...
INSERT INTO `stagiaire` (`id`, `nom`, `prenom`, `date_nais`, `ville`, `email`, `tel`) VALUES
	...
	(2, 'Kennedy', 'Leon', '1977-03-27 00:00:00', 'Washington DC', 'leon.kennedy@protonmail.gouv', '555-0124'),
	(3, 'Wong', 'Ada', '1974-08-11 00:00:00', 'Chicago', 'ada.wong@gmail.com', '555-0125'),
	...
	(7, 'Aiken', 'Richard', '1973-05-19 00:00:00', 'Boston', 'richard.aiken@gmail.com', '555-0129'),
	(8, 'Wesker', 'Albert', '1960-12-12 00:00:00', 'New York', 'albert.wesker@umbrella.com', '555-0130'),
	(9, 'Redfield', 'Chris', '1973-01-22 00:00:00', 'Dallas', 'chris.redfield@lycos.fr', '555-0131');
